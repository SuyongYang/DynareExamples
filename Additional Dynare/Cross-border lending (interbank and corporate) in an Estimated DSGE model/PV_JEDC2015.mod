...
% codes by Gauthier Vermandel  - gauthier@vermandel.fr
% I thank Lazar Milivojevic for pointing a wrong calibration in the shared version of the code.
% This code reproduces figures 6, 7 and 8
...
model(linear);
    ...
    // Capital producer 
	[name='Ex post return on capital - eq 29']
	...
	[name='shadow value of capital - eq 28']
   ...
   // Entrepreneur
	...
	// BANKING SYSTEM
    [name='Marginal cost of loans eq 10']
	...
	[name='sticky real lending rate - eq 11']
	...
	r_L_f - rr_f = s_B_f;
	 // Illiquid Bank
    [name='Illiquid bank capital law of motion - eq 6']
    ...
    // Aggregation
	[name='Market clearing for goods - eq 31']
    ...
    [name='corporate credit market equilibrium']
    ...
    [name='interbank market clearing']
	...
	[name='Exogenous shocks - periphery']
	...
	[name='Exogenous shocks - ECB rate']
...
stoch_simul(order=1,irf=24) y_h y_f c_h c_f pic_h pic_f r;
