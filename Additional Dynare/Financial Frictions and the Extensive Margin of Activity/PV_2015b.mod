% Financial frictions and the extensive margin of activity (2015) Poutineau Vermandel
...
parameters	beta alpha delta mu sigmaL chi Fe kappa_P xi_P epsilon gy hh chi_I chi_E psi rho phi_pi phi_pic phi_y phi_dy
			L_QK R eta_d H RL sigmaC R obsFactor theta gamma wmin ka TT phi N_K varkappa kappa_L mu_B mu_L mu_P mu_W kappa_W xi_W u_p u_w 
...
stoch_simul(order=1) ln_yd ln_y ln_pi ln_i ln_ne ln_rL ln_l ln_p ln_v ln_c ln_n ln_r;
