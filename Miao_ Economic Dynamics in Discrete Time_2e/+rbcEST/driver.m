...
oo_.steady_state(3) = 2.2;
oo_.steady_state(2) = (-0.26);
oo_.steady_state(5) = (-1.098);
oo_.steady_state(4) = (-1.44);
oo_.steady_state(1) = 0.005;
oo_.steady_state(6) = 0.7;
oo_.steady_state(7) = (-3.3);
...
estim_params_.param_vals = [estim_params_.param_vals; 3, NaN, (-Inf), Inf, 2, 1.65, 0.02, NaN, NaN, NaN ];
...
save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'rbcEST_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
