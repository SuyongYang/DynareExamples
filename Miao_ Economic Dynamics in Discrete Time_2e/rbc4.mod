...
%Compute Solutions for different values of Frisch elasticity of labor supply
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
parameters beta chi delta alpha rho nu;

%----------------------------------------------------------------
% 2. Calibration
%----------------------------------------------------------------
% 
% U(c,n) = log(c) -chi*n^(1+nu)/(1+nu)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
// Labor supply
 chi*exp(lh)^nu/exp(lambda) = exp(lw);
